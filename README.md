...
Giá vàng đã giảm xuống ${currentPrice}`
};
...
Giá vàng đã vượt ngưỡng ${currentPrice}`
};
...
# PHẦN 3: KẾT LUẬN
Hệ thống giám sát giá vàng theo thời gian thực đã được xây dựng thành công trên nền tảng Docker Compose với các thành phần Node-RED, MariaDB, InfluxDB, Flask API, Nginx và Grafana.
